...
#  serial_range = np.array([ [34,42], [28,34], [21,26], [16,21], [12,17] ])
  for i in range(5):
      ...
      img = ax.scatter(phi, theta, c=time_c, norm=norm, cmap=cmap, s=5., edgecolors='None', alpha=0.5)
...
#  ax.set_ylabel(r'$\theta\ [^o]$',fontdict=font)
  ...
  ax.set_title('proton_angular_distribution', va='bottom', y=1., fontsize=20)
...
#lt.figure(figsize=(100,100))
  ...
  fig.savefig(to_path+'proton_theta_phi.png',format='png',dpi=160)
  plt.close("all")
  print('finised ')
