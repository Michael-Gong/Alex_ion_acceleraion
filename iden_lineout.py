...
def processplot(n): 
  ...
  n3d_z=len(eexx[0,0,:])
  n3d_y=len(eexx[0,:,0])
  ex = (eexx[:,n3d_y//2-1,n3d_z//2-1]+eexx[:,n3d_y//2,n3d_z//2-1]+eexx[:,n3d_y//2-1,n3d_z//2]+eexx[:,n3d_y//2,n3d_z//2])/4 
  np.savetxt('./iden_lineout_'+str(n).zfill(4)+'.txt',ex)
  np.savetxt('./iden_lineout_x.txt',x)
