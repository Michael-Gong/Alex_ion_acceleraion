...
def processplot(n): 
    ...
    var0  = data['Electric Field/Ex_averaged'].data/exunit
...
#    print('here2')
    ...
    vec_index = vec_var > 2.0
    # Color by azimuthal angle
    # Flatten and normalize
    c = (vec_var[vec_index] - 2.0) / 8
    c = c.ravel()
...
#    cbar.set_label(name+r'$[m_ec\omega/|e|]$',fontdict=font)
    ...
    #plot for y_z plane
    var1  = data['Electric Field/Ey_averaged'].data/bxunit
    var2  = data['Electric Field/Ez_averaged'].data/bxunit
