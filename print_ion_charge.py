...
##end for norm colorbar####
  ...
  for dir_n in ['no40','no60','no140','no180','no220']:
    ...
    #  weight = Ntot/(1200*360*360*50)
      ...
      for n in np.arange(start,stop+step,step):
          ...
          if set_relativistic == 1:
              ...
              condition = (ek_2>200) & (ek_2<300)
              charge_2 = np.sum(ww_2[condition])*1.6e-19              
       
              print(from_path+str(n).zfill(4)+'<10 degree:',charge_2, '  all degree:',charge_1) 
