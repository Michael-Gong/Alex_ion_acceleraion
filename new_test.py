...
#  youwant = ['electron_x_px','electron_density','electron_en','electron_theta_en','ey'] #,'electron_ekbar']
  ...
  set_relativistic =0 
  for i in [1]:
      dist_x1 = np.loadtxt('gird_15_x.txt')
      dist_x2 = dist_x1
      den1 = np.loadtxt('gird_15_b.txt')*weight  
      den2 = np.loadtxt('gird_15_r.txt')*weight  
      dist_x3 = np.loadtxt('gird_27_x.txt')
      dist_x4 = dist_x3
      den3 = np.loadtxt('gird_27_b.txt')*weight  
      den4 = np.loadtxt('gird_27_r.txt')*weight  
      ...
      plt.legend(loc='best',fontsize=19,framealpha=1.0)
    ...
    #        plt.text(250,6e9,'t='+str(round(time/1.0e-15,0))+' fs',fontdict=font)
      ...
      fig.savefig('./new_nonrelativistic_'+str(15).zfill(4)+'_'+str(27).zfill(4)+'.png',format='png',dpi=160)
      plt.close("all")
