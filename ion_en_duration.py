...
##end for norm colorbar####
  ...
  dir_list = ['t20','t40','t50','v484','t80','t100','t120']  
  dir_n    = [19,   23,   27,   27,    35,    47,   51]
...
#        plt.text(250,6e9,'t='+str(round(time/1.0e-15,0))+' fs',fontdict=font)
  ...
  fig.savefig(to_path+'ion_en_duration.png',format='png',dpi=160)
  plt.close("all")
  print(to_path+'ion_en_duration.png') 
