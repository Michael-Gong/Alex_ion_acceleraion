...
#  plt.plot(t,y0,linestyle='-',linewidth=2.0,zorder=1)
  y1= (1-30.0/(0.5*190))**0.5*0.345*190*(t/3.33333333333)**0.5
...
#  plt.plot(t,y3,linestyle='-',linewidth=2.0,zorder=1)
  ...
  plt.yticks([0,100,200,300,400],fontsize=font_size);
  plt.grid(which='major',color='k', linestyle='--', linewidth=0.05)
...
#  plt.plot(power,upper,'--k',linewidth=4, label='Eqs.(4,5)',zorder=0)
  ...
  y1= (1-n_in/(0.5*190))**0.5*0.345*190*18.0**0.5 #(1-n_in/95.0)**0.5*285  # k*a_0*[1-n_e/(0.5*a_0n_cr)]**0.5*(tau)**0.5; k= 
...
#  plt.plot(power,upper,'--k',linewidth=4, label='Eqs.(4,5)',zorder=0)
  ...
  y1= (1-30.0/(0.5*190))**0.5*0.345*190*18.0**0.5+np.zeros_like(no_line)  # k*a_0*[1-n_e/(0.5*a_0n_cr)]**0.5*(tau)**0.5; k=0.354
...
#  plt.plot(power,upper,'--k',linewidth=4, label='Eqs.(4,5)',zorder=0)
  ...
  y1= (1-30.0/(0.5*line_a0))**0.5*0.345*line_a0*18.0**0.5  # k*a_0*[1-n_e/(0.5*a_0n_cr)]**0.5*(tau)**0.5; k=0.354
...
#  plt.legend(loc='best',fontsize=18,framealpha=0.5)
  ...
  plt.subplots_adjust(left=0.12, bottom=0.1, right=0.99, top=0.98,
                wspace=0.25, hspace=0.24)
    #        plt.text(250,6e9,'t='+str(round(time/1.0e-15,0))+' fs',fontdict=font)
  fig = plt.gcf()
  fig.set_size_inches(13.2, 10)
  fig.savefig('./wrap_en_scaling_20MeV.png',format='png',dpi=160)
  plt.close("all")
