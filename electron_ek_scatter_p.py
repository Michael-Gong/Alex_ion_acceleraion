...
def processplot(n): 
  ...
  part13_id = data['Particles/ID/subset_Only_Energetic_Electrons/Electron'].data
  part13_id = part13_id[ (Ek>600) ]
...
#  print('part13_id size is ',part13_id.size,' max ',np.max(part13_id),' min ',np.min(part13_id))
  ...
  temp_id = data['Particles/ID/subset_Only_Energetic_Electrons/Electron'].data
...
#lt.figure(figsize=(100,100))
  ...
  fig.savefig(to_path+'electron_3d_scatter_Ek'+str(n).zfill(4)+'.png',format='png',dpi=320)
  plt.close("all")
